...
import com.myschool.schoolcircle.dao.GroupDao;
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case HandlerKey.GET_SUCCESS:
                    ...
                    GroupDao dao = new GroupDao(GroupChat.this);
                    dao.insert(mGroup);
                    break;
                case HandlerKey.GET_FAIL:
                    ToastUtil.showToast(GroupChat.this, "更新失败", Toast.LENGTH_SHORT);
                    mProgressDialog.cancel();
                    break;
...
//    }
    ...
    private void init() {
        ...
        if (mGroup == null) {
            mProgressDialog = ProgressDialogUtil.getProgressDialog(this, "更新群组信息中...");
            ...
            //进入群聊
            mConversation = JMessageClient.getGroupConversation(mGroup.getGroupId());
            JMessageClient.enterGroupConversation(mGroup.getGroupId());
    ...
    //获取群组信息
    public void getGroupTable(long id) {
        //先向本地数据库查询群组资料
        ...
        if (mGroup == null) {
            ...
            //如果本地不存在群组资料，就向服务器请求
            RequestParams params = new RequestParams(Config.URL + "Group");
            params.setConnectTimeout(8000);
            params.addBodyParameter("type", "queryGroup");
            ...
            x.http().post(params, new Callback.CommonCallback<String>() {
                ...
                public void onSuccess(String result) {
                    if (!"nothing".equals(result)) {
                        Gson gson = new Gson();
                        mGroup = gson.fromJson(result, Tb_group.class);
                        mHandler.sendEmptyMessage(HandlerKey.GET_SUCCESS);
                    } else {
                        mProgressDialog.cancel();
                        ToastUtil.showToast(GroupChat.this,"群组信息获取失败",
                                Toast.LENGTH_SHORT);
                ...
                public void onError(Throwable ex, boolean isOnCallback) {
                    mHandler.sendEmptyMessage(HandlerKey.GET_FAIL);
                }
    ...
    private void initData() {
        ...
        mAdapter = new GroupChatAdapter(GroupChat.this, mMessages, application.getMyInfo());
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_send:
                ...
                if (!msg.isEmpty()) {
                    ...
                    ToastUtil.showShortToast(GroupChat.this,
                            R.string.chat_message_cannot_be_empty);
                }
                break;
            case R.id.ib_image:
                //打开图片选择界面
                Intent intent = new Intent(GroupChat.this, GroupImageActivity.class);
        ...
        if (mConversation != null) {
            ...
            textMessage.setOnSendCompleteCallback(new BasicCallback() {
                ...
                public void gotResult(int i, String s) {
                    if (i == 0) {
                        //发送成功，刷新界面
//                        ToastUtil.showToast(GroupChat.this, "发送成功", Toast.LENGTH_SHORT);
                    } else {
                        //发送失败
                        ToastUtil.showToast(GroupChat.this, "发送失败", Toast.LENGTH_SHORT);
                    }
                }
            });
            ...
            //重新获取会话
            mConversation = getConversation(mGroup.getGroupId());
            //递归
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_group:
                ...
                if (mGroup.getCreatorUsername().equals(application.getMyInfo().getUserName())) {
                    intent.putExtra("type", "ownerGroup");
                } else {
                    intent.putExtra("type", "memberGroup");
                }
