...
public class GroupImageAdapter extends BaseAdapter {
    public static ArrayList<String> mSelected = new ArrayList<>();//保存图片的是否选择中状态
    private String mDirPath;
    private List<String> mImagePaths;
    private LayoutInflater mInflater;

    public GroupImageAdapter(Context context, List<String> mData, String dirPath) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.imageButton.setImageResource(R.mipmap.ic_check_box_outline_blank_white_24dp);
            ...
            public void onClick(View view) {
                ...
                if (mSelected.contains(filePath)) {
                    ...
                    viewHolder.imageButton.setImageResource(
                            R.mipmap.ic_check_box_outline_blank_white_24dp);
                } else {
                    //未被选中，就添加
                    mSelected.add(filePath);
                    viewHolder.imageView.setColorFilter(Color.parseColor("#77000000"));
                    viewHolder.imageButton.setImageResource(R.mipmap.ic_check_box_white_24dp);
                }
            }
        });
        ...
        if (mSelected.contains(filePath)) {
            viewHolder.imageView.setColorFilter(Color.parseColor("#77000000"));
            viewHolder.imageButton.setImageResource(
                    R.mipmap.ic_check_box_white_24dp);
        }
